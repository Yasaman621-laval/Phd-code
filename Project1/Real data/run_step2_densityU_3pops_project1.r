...
jset <-  as.numeric(args[1])
 ...
 file.rjobs = "/lustre06/project/6005709/yatah3/real_data_backup/real-data/project1/"
 ...
 output_sub_folder0 = "/home/yatah3/projects/def-thchlava/yatah3/real_data_backup/real-data/runR-mixer/"
...
out_dir = "/lustre06/project/6005709/yatah3/real_data_backup/real-data/out/"
...
output_sub_folder_uDensity = paste0("/lustre06/project/6005709/yatah3/real_data_backup/real-data/project1/", savename, "/")
...
gc()
      ...
      for(rr in 1:length(rho_vec)){
        ...
        Allrho_WBMatrix_list[[rr]] = wBMatrix
         Allrho_DensityU_list[[rr]] <- inputs
         
        rm(output, wBMatrix,inputs)
        gc()
      }
   save(
   Allrho_DensityU_list = Allrho_DensityU_list,
  pi_init_matrix = es_alphaMatrix,
  Allrho_WBMatrix_list = Allrho_WBMatrix_list,
  file = subtau_saveoutfile
)
      rm(es_alphaMatrix,Allrho_WBMatrix_list,Allrho_DensityU_list)
    }
